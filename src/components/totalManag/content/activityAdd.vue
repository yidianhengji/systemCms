        ...
        <el-card class="box-card">
            ...
            <div class="addFromListBox">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    ...
                    <el-form-item label="活动地点" prop="name" class="form-control">
                        <el-input v-model="ruleForm.name" placeholder="请输入活动地点"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="积分设置" prop="name" class="form-control">
                        <el-input v-model="ruleForm.name" placeholder="请输入活动积分"></el-input>
                    </el-form-item>
                    <el-form-item label="活动负责人" class="form-control">
                        <el-input v-model="ruleForm.name" placeholder="请输入活动负责人（积分按照个人设置，总积分不能大于10000）"></el-input>
                    </el-form-item>
