            ...
            <div class="addFromListBox">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
					...
					<el-form-item label="栏目" prop="name">
                        <el-select v-model="ruleForm.region" placeholder="请选择栏目">
                            <el-option label="西湖街道办" value="shanghai"></el-option>
                            <el-option label="八方小区" value="beijing"></el-option>
                        </el-select>
                    </el-form-item>
					...
					<el-form-item label="文章来源" prop="name" style="width: 318px;">
                        <el-input v-model="ruleForm.name" placeholder="请输入文章来源"></el-input>
                    </el-form-item>
					<el-form-item label="作者" style="width: 318px;">
                        <el-input v-model="ruleForm.name" placeholder="请输入文章来源"></el-input>
                    </el-form-item>
					<el-form-item label="编辑" style="width: 318px;">
                        <el-input v-model="ruleForm.name" placeholder="请输入文章来源"></el-input>
                    </el-form-item>
