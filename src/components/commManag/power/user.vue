<template>
  <div class="__userList">
    ...
    <el-dialog :title="modelTypeName" :visible.sync="dialogFormVisible" :modal-append-to-body="false"
        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          ...
          <el-form-item label="角色" prop="roleId" class="form-control">
            <el-select v-model="ruleForm.roleId" placeholder="请选择角色">
              <el-option v-for="(item,index) in roleQueryData" :key="index" :label="item.name"
