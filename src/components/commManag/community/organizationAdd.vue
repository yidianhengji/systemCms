        ...
        <el-card class="box-card">
            ...
            <div class="addFromListBox">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
					...
					<el-form-item label="负责权限" prop="mobile" class="form-control">
                        <el-checkbox-group v-model="ruleForm.type">
							<el-checkbox label="活动" key="1" name="type"></el-checkbox>
							<el-checkbox label="任务" key="1" name="type"></el-checkbox>
							<el-checkbox label="垃圾分类" key="1" name="type"></el-checkbox>
						</el-checkbox-group>
                    </el-form-item>
